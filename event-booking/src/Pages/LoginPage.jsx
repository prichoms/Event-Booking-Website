        ...
        <DialogContent dividers style={{ textAlign: 'center' }}>
          ...
          <>
            ...
            <center>
              ...
              <div className="rowA">
                <div className="middle_Container"><input id="tab-1" type="radio" name="tab" class="sign-in" value="User" /><label for="tab-1" class="tab" >User</label></div>
                <div className="middle_Container_right"><input id="tab-2" type="radio" name="tab" class="sign-up" value="Organizer" /><label for="tab-2" class="tab" >Organizer</label></div>
              </div>
            </center>
