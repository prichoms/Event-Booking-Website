...
import datpop from '../../scraped_data/popular_events.json';
...
export const getMovies = (id) => (dispatch) => {
  ...
  // return axios
  //   .get(jsonmoviedata)
  //   // .get({"data":dat.data.filter(ele => ele._id == id)})
  //   .then((res) => {
